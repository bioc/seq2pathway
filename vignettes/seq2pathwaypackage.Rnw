...
Now install seq2pathway and the data package:
<<setup>>=
install.packages("seq2pathway",repos = "http://cran.us.r-project.org")
...
> result_FAIME<-gene2pathway_test(dat= dat_chip, 
                FisherTest=TRUE, EmpiricalTest=TRUE, method="FAIME", 
                alpha=5, logCheck=FALSE, na.rm=FALSE)
    \end{verbatim}
...
@
    ...
    \begin{verbatim}
> result_FAIME<-gene2pathway_test(dat= dat_chip, FisherTest=TRUE, EmpiricalTestALSE,
