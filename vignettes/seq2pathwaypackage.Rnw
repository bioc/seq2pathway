...
For Windows, the Python should be installed at ``C:\Users\<USERNAME>\AppData\Local\Programs\Python\Python38'' (default). Make sure you click 'add python to PATH' when installing.
